...
final List<Task> _taskList=[
    ...
    new Task('Have cofee with sam',true),
  ...
  Widget build(BuildContext context){
    return ListView.builder(
      ...
      itemBuilder: (context,index){
        return _taskList[index].isFinish ? _taskComplete(_taskList[index].task):_taskUncomplete(_taskList[index].task);
  ...
  Widget _taskUncomplete(String task) {
    return Container(
      ...
      child: Padding(
          ...
          child: Row(
            children:<Widget>[
              Icon(Icons.radio_button_unchecked,color: Theme.of(context).accentColor,
              size: 20,
              ),
              SizedBox(width:28),
              Text(task)
