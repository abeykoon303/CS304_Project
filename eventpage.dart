...
import 'package:flutterapp/widget/custom_icon_decoration.dart';
...
final List<Event> _eventList=[
  new Event('08.00', 'have coffee with sam','Personal', true),
  new Event('10.00', 'Meet with sales','work', true),
  new Event('12.00', 'call tom about appointment','work', false),
  new Event('15.00', 'edit api documentation','Personal', false),
  ...
  Container _lineStyle(BuildContext context,double iconSize,int index,int listLength,bool isFinish) {
    return Container(
              ...
              decoration:BoxDecoration(
                ...
                boxShadow: [
                  BoxShadow(offset:Offset(0,3),color:Color(0x20000000),blurRadius:5  )
                ]
              ) ,
              child: Icon(
                isFinish
                 ? Icons.fiber_manual_record :Icons.radio_button_unchecked,
